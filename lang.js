...
(function () {
  ...
  var T = {
    ...
    en: {
      ...
      'tl2.d1':    'As part of my PhD, I worked on unsupervised searches for signatures of BSM physics at the Large Hadron Collider (on data recorded at the CMS Detector). I was (and still am) a member of the CMS Collaboration, and was a major contributor to the first model-agnostic search within the collaboration, which looked for hints of new physics in dijet final states (for more details, head over to my <a href="publications.html" class="inline-link">Publications</a> page). I also developed the novel 1P1Q encoding for representing jet data on qubit systems, and provided what was possibly the first demonstration of quantum machine learning on real collider data (recorded at the CMS Detector in 2016). I was supervised by <a href="https://etpwww.etp.kit.edu/~klute/" target="_blank" rel="noopener" class="inline-link">Alexander von Humboldt Prof.\u00a0Dr.\u00a0Markus Klute</a> and <a href="https://profiles.imperial.ac.uk/b.maier" target="_blank" rel="noopener" class="inline-link"><strong>Dr.\u00a0Benedikt Maier</strong></a> (Schmidt AI Fellow, Imperial College London).',
      ...
      'pub.tab.talks':        'Talks',
      't1.meta': 'LHC Quantum Computing Workshop, Valencia, Spain',
      't1.date': '24 September 2026',
      't2.meta': 'ML4Jets 2026, Vienna, Austria',
      't2.date': '18 September 2026',
      't3.meta': 'EUCAIF 2026, Heidelberg, Germany',
      't3.date': '26 August 2026',
      't4.meta': 'EUCAIF 2026, Heidelberg, Germany',
      't4.date': '24 August 2026',
      't5.meta': 'LHCP 2026, Paris, France',
      't5.date': '19 May 2026',
      't6.meta': 'ML4Jets 2025, Caltech, Pasadena, USA (presented by B. Maier)',
      't6.date': '22 August 2025',
      't7.meta': 'EPS-HEP 2025, Marseille, France',
      't7.date': '9 July 2025',
      't8.meta': 'ML4Jets 2024, Paris, France',
      't8.date': '7 November 2024',
      ...
      'p7.status': 'ICML 2026: AI4Physics Workshop &thinsp;&middot;&thinsp; In peer-review',
      ...
      'p5.status': 'Published in <em>Machine Learning: Science and Technology</em> &thinsp;&middot;&thinsp; IF&nbsp;4.2',
    ...
    de: {
      ...
      'tl2.d1':    'Im Rahmen meiner Promotion arbeitete ich an un\u00fcberwachten Suchen nach Signaturen von Physik jenseits des Standardmodells (BSM) am Large Hadron Collider (anhand von Daten, die am CMS-Detektor aufgezeichnet wurden). Ich war (und bin es immer noch) Mitglied der CMS-Kollaboration und einer der Hauptbeitragenden zur ersten modellunabh\u00e4ngigen Suche innerhalb der Kollaboration, die nach Hinweisen auf neue Physik in Dijet-Endzust\u00e4nden suchte (mehr dazu auf meiner <a href="publications.html" class="inline-link">Publikationen</a>-Seite). Au\u00dferdem entwickelte ich die neuartige 1P1Q-Kodierung zur Darstellung von Jet-Daten auf Qubit-Systemen und lieferte damit m\u00f6glicherweise die erste Demonstration von Quanten-maschinellem Lernen auf echten Kollisionsdaten (aufgezeichnet am CMS-Detektor im Jahr 2016). Ich wurde betreut von <a href="https://etpwww.etp.kit.edu/~klute/" target="_blank" rel="noopener" class="inline-link">Alexander-von-Humboldt-Prof.\u00a0Dr.\u00a0Markus Klute</a> und <a href="https://profiles.imperial.ac.uk/b.maier" target="_blank" rel="noopener" class="inline-link"><strong>Dr.\u00a0Benedikt Maier</strong></a> (Schmidt AI Fellow, Imperial College London).',
      ...
      't1.meta': 'LHC Quantum Computing Workshop, Valencia, Spanien',
      't1.date': '24. September 2026',
      't2.meta': 'ML4Jets 2026, Wien, Österreich',
      't2.date': '18. September 2026',
      't3.meta': 'EUCAIF 2026, Heidelberg, Deutschland',
      't3.date': '26. August 2026',
      't4.meta': 'EUCAIF 2026, Heidelberg, Deutschland',
      't4.date': '24. August 2026',
      't5.meta': 'LHCP 2026, Paris, Frankreich',
      't5.date': '19. Mai 2026',
      't6.meta': 'ML4Jets 2025, Caltech, Pasadena, USA (vorgestellt von B. Maier)',
      't6.date': '22. August 2025',
      't7.meta': 'EPS-HEP 2025, Marseille, Frankreich',
      't7.date': '9. Juli 2025',
      't8.meta': 'ML4Jets 2024, Paris, Frankreich',
      't8.date': '7. November 2024',
      ...
      'p7.status': 'ICML 2026: AI4Physics Workshop &thinsp;&middot;&thinsp; Im Peer-Review-Verfahren',
      ...
      'p5.status': 'Veröffentlicht in <em>Machine Learning: Science and Technology</em> &thinsp;&middot;&thinsp; IF&nbsp;4.2',

      'p7.abstract': 'Große maschinelle Lernmodelle profitieren erheblich von multimodalen Eingaben, die eine komplementäre Sicht auf dasselbe Beispiel bieten. Wir stellen QUIVER (QUantum-Informed Views for Enhanced Representations) vor, ein Paradigma, das klassische datengetriebene Merkmale um eine Quanten-Fisher-Sicht bereichert: eine geometrisch motivierte, basisunabhängige Zusammenfassung höherer Korrelationen, die durch einen variationellen Quantenschaltkreis (VQC) erfasst wird, der für dieselbe Aufgabe trainiert wurde. Im Gegensatz zur klassischen Merkmalsaugmentierung kodiert die Quanten-Fisher-Informationsmatrix die intrinsische Geometrie der gelernten Quantenzustandsmannigfaltigkeit. Obwohl diese Merkmalskarte, motiviert durch die Quanteninformationstheorie, klassisch gewöhnlich schwer zu modellieren ist, kann sie statistische Strukturen aufdecken, die zusätzliche klassische Daten oder Modellkapazität nur schwer erlernen. Dies macht die Quanten-Fisher-Sicht zu einer echten komplementären Modalität und nicht zu einer redundanten. Wir zeigen, dass QUIVER die Standardleistungsmetriken auf zwei Benchmark-Datensätzen aus sehr unterschiedlichen Bereichen verbessert: QM9 zur Vorhersage von Moleküleigenschaften und JetClass zur Vorhersage des Jet-Flavors am Large Hadron Collider (LHC). Der Kernbeitrag ist jedoch domänenunabhängig: Die Quanten-Fisher-Sicht kann durch gezielte Modifikationen der Basisarchitektur in eine breite Klasse von Modellarchitekturen integriert werden, um Informationen über die Quantengeometrie des Problems einzubeziehen. Diese Ergebnisse zeigen, dass quantengeometrische Merkmale, die aus simulierten variationellen Schaltkreisen extrahiert werden, messbare Vorteile für maschinelle Lernaufgaben liefern können, noch vor dem Aufkommen fehlertoleranter Quantenhardware.',
